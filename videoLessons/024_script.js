...
let personalMovieDB = {
    ...
    privat: false,
    start: function () {
        this.count = +prompt("Сколько фильмов вы уже посмотрели?", "4");
    ...
    writeYourGenres: function () {
        for (let i = 1; i <= 3; i++) {
            ...
            if (a == '' || a == null) {
                console.log(`Вы ввели некорректные данные или не ввели их вовсе, попробуйте ещё раз`);
                i--;
            } else {
                this.genres.push(a);
            }
    ...
    showMyDB: function () {
        if (!this.privat) {
            console.log(`Свойство приватности установлено в значении- ${this.privat}, 
        значит список не приватный, можно открыть`);
            console.log(this);
        } else {
            console.log(`Свойство приватности установлено в значении- ${this.privat}, 
        значит список приватный, нельзя просматривать`);
        }
